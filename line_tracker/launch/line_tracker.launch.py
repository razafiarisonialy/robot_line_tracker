...
def generate_launch_description():
    ...
    arg_base_speed      = DeclareLaunchArgument('base_speed',      default_value='0.15',  description='Vitesse linéaire de croisière (m/s)')
    ...
    # --- motor_node ---
    arg_gopigo_speed = DeclareLaunchArgument('gopigo_speed', default_value='200',  description='Vitesse GoPiGo3 en DPS')
    arg_gopigo_max   = DeclareLaunchArgument('gopigo_max',   default_value='400',  description='Vitesse GoPiGo3 max en DPS')
    arg_steer_gain   = DeclareLaunchArgument('steer_gain',   default_value='50.0', description='Gain de braquage (0 = cinématique)')

    # ── Nœud 0 : v4l2_camera_node
    ...
    motor_node = Node(
        ...
        output     = 'screen',
        parameters = [{
            'base_speed': LaunchConfiguration('gopigo_speed'),
            'max_speed':  LaunchConfiguration('gopigo_max'),
